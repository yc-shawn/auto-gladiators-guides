...
export const loops: Loop[] = [
  // 🔵 经由 魔能爆轰 回路（法伤→暴击）
  {
    ...
    summary: '暴击→寒霜→法伤→暴击',
    route: 'blue',
    requiredSects: [SECT.CRIT, SECT.FROST],
  },
  {
    id: 2,
    ...
    summary: '暴击→怒火→法伤→暴击',
    route: 'blue',
    requiredSects: [SECT.CRIT, SECT.FURY],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    route: 'blue',
    requiredSects: [SECT.CRIT, SECT.REGEN, SECT.FROST],
  },
  {
    id: 5,
    ...
    route: 'blue',
    requiredSects: [SECT.CRIT, SECT.REGEN, SECT.FURY],
  },
  {
    id: 6,
    ...
    route: 'blue',
    requiredSects: [SECT.CRIT, SECT.SHIELD, SECT.FROST],
  },
  {
    id: 7,
    ...
    route: 'blue',
    requiredSects: [SECT.CRIT, SECT.SHIELD, SECT.FURY],
  },
  {
    id: 8,
    ...
    route: 'blue',
    requiredSects: [SECT.CRIT, SECT.REGEN, SECT.SHIELD, SECT.FROST],
  },
  {
    id: 9,
    ...
    route: 'blue',
    requiredSects: [SECT.CRIT, SECT.REGEN, SECT.SHIELD, SECT.FURY],
  },
  // 🔴 经由 物理暴击 回路（物理→暴击）
  {
    id: 10,
    ...
    summary: '暴击→护盾→物理→暴击',
    route: 'red',
    requiredSects: [SECT.CRIT, SECT.SHIELD, SECT.ATTACK],
  },
  {
    id: 11,
    ...
    route: 'red',
    requiredSects: [SECT.CRIT, SECT.REGEN, SECT.SHIELD, SECT.ATTACK],
  },
  {
    id: 12,
    ...
    summary: '暴击→回复→物理→暴击',
    route: 'red',
    requiredSects: [SECT.CRIT, SECT.REGEN, SECT.ATTACK],
  },
];
